package com.feri.pay_api.pay.wxchat;

import com.feri.pay_api.util.HttpUtil;
...
public class WxChatPayUtil {
   ...
   //统一下单接口
    public Map<String,String> createOrder(Map<String,String> map){
       ...
       try{
           String sign=generateSignature(map,appkey,WXPayConstants.SignType.MD5);
           map.put("sign",sign);
           String responsexml=HttpUtil.postData("https://api.mch.weixin.qq.com/pay/unifiedorder",mapToXml(map));
    ...
    public Map<String,String> searchOrder(String orderid){
        ...
        try{
            ...
            String responsexml=HttpUtil.postData("https://api.mch.weixin.qq.com/pay/orderquery",mapToXml(map));
    ...
    public Map<String,String> closeOrder(String orderid){
        ...
        try{
            ...
            map.put("sign",sign);
            String responsexml=HttpUtil.postData("https://api.mch.weixin.qq.com/pay/closeorder",mapToXml(map));
            return xmlToMap(responsexml);
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public String downbill(String bill_date){
        ...
        try{
            String sign=generateSignature(map,appkey,WXPayConstants.SignType.HMACSHA256);
            map.put("sign",sign);
            String responsexml=HttpUtil.postData("https://api.mch.weixin.qq.com/pay/downloadbill",mapToXml(map));
            return responsexml;
        }catch (Exception e){
            e.printStackTrace();
        }
